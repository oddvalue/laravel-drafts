...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-drafts.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-drafts)
...
```bash
php artisan vendor:publish --tag="laravel-drafts-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-drafts-views"
```
